...
import { HAND_TYPE_OPTIONS, HandType } from '../model'

defineOptions({
  name: 'HandTypeSelector'
})

interface Props {
  /** 绑定值 */
  modelValue?: HandType | HandType[] | null | undefined
  /** 占位符 */
  placeholder?: string
  /** 是否可清空 */
  clearable?: boolean
...
interface Emits {
  (e: 'update:modelValue', value: HandType | HandType[] | null): void
  (e: 'change', value: HandType | HandType[] | null): void
  (e: 'clear'): void
  (e: 'blur'): void
  (e: 'focus'): void
  (e: 'visible-change', visible: boolean): void
  (e: 'remove-tag', value: HandType): void
}
...
const innerValue = computed({
  ...
  set: (value) => emit('update:modelValue', value as HandType | HandType[] | null)
})
